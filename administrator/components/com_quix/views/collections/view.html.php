    ...
    protected function addToolbar()
    {
        ...
        if ($canDo->get('core.create')) {
            ...
            $toolbar->appendButton('Custom',
                "<a href='#' data-toggle='modal' class='btn hasTooltip' data-target='#newLibraryModal' data-title='".JText::_('Visual Builder')."'><i class='icon-new'></i> ".JText::_('JTOOLBAR_NEW')."</a>",
                'new-visual');
            ...
            // JToolBarHelper::addNew('collection.add', 'COM_QUIX_JTOOLBAR_NEW_LIB_OLD');
            $toolbar->appendButton('Custom',
                '<button onclick="Joomla.submitbutton(\'collection.add\');" class="btn btn-small button-new"><span class="icon-new icon-white" aria-hidden="true"></span>'.JText::_('COM_QUIX_JTOOLBAR_NEW_LIB_OLD'),
                'new');
        }
